...
int main(){
	...
	bool condicion_1 = !(number_1 > number_2 || number_1 > number_3);
	
	printf("  1ra condici%cn:\n", 162);
	printf("  %d", condicion_1);
	printf("\n\n");
	
	// Condición !(n2>n1 or n2>n3)
	bool condicion_2 = !(number_2 > number_1 || number_2 > number_3);
	
	printf("  2da condici%cn:\n", 162);
	printf("  %d", condicion_2);
	printf("\n\n");
	
	// Condición !(n3>n1 or n3>n2)
	bool condicion_3 = !(number_3 > number_1 || number_3 > number_2);
	
	printf("  3ra condici%cn:\n", 162);
	printf("  %d", condicion_3);
	printf("\n\n\n");
	
	// Imprimir tabla lógica NOT
	printf("Representaci%cn de la tabla l%cgica NOT.\n\n", 162, 162);
	...
	printf("\n");
	printf("  Programa Tabla l%cgica NOT creado por: Avila Barba Erick Yahir\n\n", 162);
	getch();
